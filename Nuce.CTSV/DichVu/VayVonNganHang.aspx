<%@ Page Title="Vay Vốn Ngân Hàng" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="VayVonNganHang.aspx.cs" Inherits="Nuce.CTSV.VayVonNganHang" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">vay vốn ngân hàng chính sách - xã hội</div>
</asp:Content>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btnVayVonNganHangXa" onclick=" VayVonNganHang.update();">Xác nhận mã</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnXoa" onclick=" VayVonNganHang.delete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnHoanThanh" onclick=" VayVonNganHang.complete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-end">
                <div class="col-12 col-md-3">
                    <button
                        ...
                        type="button"
                        onclick="VayVonNganHang.ThemMoi();"
                        >
                        Thêm mới
                    </button>
                </div>
    ...
    <script>
        ...
        var VayVonNganHang = {
            ...
            update: function () {
                ...
                if (VayVonNganHang.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + VayVonNganHang.ID + "&&Ma=" + strMa + "&&Type=" + VayVonNganHang.Type, function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            initDelete: function (id, message) {
                ...
                $('#btnXoa').show();
                //$("#btnXoa").on("click", VayVonNganHang.delete);
            },
            delete: function () {
                //Update
                $("#edit_header_ThongBao1").show();
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + VayVonNganHang.ID + "&&Type=" + VayVonNganHang.Type, function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + VayVonNganHang.ID + "&&Type=" + VayVonNganHang.Type, function (data) {
                        if (data == 1) {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/VayVonNganHang_yeucaumoi";
            }
        };
    </script>
</asp:Content>

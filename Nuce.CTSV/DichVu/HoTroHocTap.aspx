<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="HoTroHocTap.aspx.cs" Inherits="Nuce.CTSV.HoTroHocTap" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">hỗ trợ học tập</div>
</asp:Content>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btnDangKyChoOXa" onclick=" DangKyChoO.update();">Xác nhận mã</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnXoa" onclick=" DangKyChoO.delete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnHoanThanh" onclick=" DangKyChoO.complete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        var DangKyChoO = {
            ...
            update: function () {
                ...
                if (DangKyChoO.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + DangKyChoO.ID + "&&Ma=" + strMa + "&&Type=1", function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            initDelete: function (id, message) {
                ...
                $('#btnXoa').show();
                //$("#btnXoa").on("click", DangKyChoO.delete);
            },
            delete: function () {
                //Update
                $("#edit_header_ThongBao1").show();
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + DangKyChoO.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + DangKyChoO.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/hotrohoctap_yeucaumoi";
            }
        };
    </script>
</asp:Content>

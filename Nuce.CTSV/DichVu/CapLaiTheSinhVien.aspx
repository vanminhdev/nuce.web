<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="CapLaiTheSinhVien.aspx.cs" Inherits="Nuce.CTSV.CapLaiTheSinhVien" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">cấp lại thẻ sinh viên</div>
</asp:Content>
            ...
            <div class="row justify-content-end">
                <div class="col-12 col-md-3">
                    <button
                        ...
                        type="button"
                        onclick="CapLaiTheSinhVien.ThemMoi();"
                        >
                        Thêm mới
                    </button>
                </div>
        ...
        var CapLaiTheSinhVien = {
            ...
            update: function () {
                ...
                if (CapLaiTheSinhVien.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Ma=" + strMa + "&&Type=1", function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            delete: function () {
                ...
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Type=1", function (data) {
                        if (data == 1) {

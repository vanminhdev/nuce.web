<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CapLaiTheSinhVien.aspx.cs" Inherits="Nuce.CTSV.CapLaiTheSinhVien" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btnCapLaiTheSinhVienXa" onclick=" CapLaiTheSinhVien.update();">Xác nhận mã</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnXoa" onclick=" CapLaiTheSinhVien.delete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnHoanThanh" onclick=" CapLaiTheSinhVien.complete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row row-no-gutters">
            <div class="col-sm-8">
                <ul class="breadcrumb">
                    ...
                    <li>Cấp lại thẻ sinh vien</li>
                </ul>
            </div>
             <div class="col-sm-4" style="text-align: right;">
                <button type="button" class="btn btn-primary" onclick="CapLaiTheSinhVien.ThemMoi();">Thêm mới</button>
            </div>
        </div>
        ...
        <div class="row row-no-gutters" runat="server" id="divThemMoi">
    ...
    <script>
        ...
        var CapLaiTheSinhVien = {
            ...
            update: function () {
                ...
                if (CapLaiTheSinhVien.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Ma=" + strMa + "&&Type=" + CapLaiTheSinhVien.Type, function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            initDelete: function (id, message) {
                ...
                $('#btnXoa').show();
                //$("#btnXoa").on("click", CapLaiTheSinhVien.delete);
            },
            delete: function () {
                //Update
                $("#edit_header_ThongBao1").show();
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Type=" + CapLaiTheSinhVien.Type, function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + CapLaiTheSinhVien.ID + "&&Type=" + CapLaiTheSinhVien.Type, function (data) {
                        if (data == 1) {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/CapLaiTheSinhVien_yeucaumoi";
            }
        };
    </script>
</asp:Content>

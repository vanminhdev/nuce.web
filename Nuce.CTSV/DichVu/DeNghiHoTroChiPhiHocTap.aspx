<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="DeNghiHoTroChiPhiHocTap.aspx.cs" Inherits="Nuce.CTSV.DeNghiHoTroChiPhiHocTap" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">Đơn đề nghị hỗ trợ chi phí học tập</div>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        var MienGiamHocPhi = {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/denghihotrochiphihoctap_yeucaumoi";
            }
        };
    </script>
</asp:Content>

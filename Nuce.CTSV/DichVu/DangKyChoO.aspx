<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="DangKyChoO.aspx.cs" Inherits="Nuce.CTSV.DangKyChoO" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">đăng ký chỗ ở</div>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        var DangKyChoO = {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/dangkychoo_yeucaumoi";
            }
        };
    </script>
</asp:Content>

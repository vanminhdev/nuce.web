<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="ThueNhaSinhVien_YeuCauMoi.aspx.cs" Inherits="Nuce.CTSV.ThueNhaSinhVien_YeuCauMoi" %>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnCapNhat1" onclick="thuenhasinhvien_yeucaumoi.update();">Xác nhận</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnVeDanhSach" onclick="thuenhasinhvien_yeucaumoi.vedanhsach();">Quay lại danh sách</button>
                </div>
            </div>
        </div>
    </div>

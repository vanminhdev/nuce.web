<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="VeXeBus.aspx.cs" Inherits="Nuce.CTSV.VeXeBus" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="main-color text-decoration-none">làm vé tháng xe bus</div>
</asp:Content>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="btnVeXeBusXa" onclick=" VeXeBus.update();">Xác nhận mã</button>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnXoa" onclick=" VeXeBus.delete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-danger" id="btnHoanThanh" onclick=" VeXeBus.complete();">Thực hiện</button>
                </div>
            </div>
        </div>
    </div>
        ...
        var VeXeBus = {
            ...
            update: function () {
                ...
                if (VeXeBus.ID > 0) {
                    try {
                        //Update
                        $.getJSON(this.url + "CapNhatMaYeuCauDichVu.aspx?ID=" + VeXeBus.ID + "&&Ma=" + strMa + "&&Type=1", function (data) {
                            $("#edit_header_ThongBao").show();
                            if (data == 1) {
            ...
            initDelete: function (id, message) {
                ...
                $('#btnXoa').show();
                //$("#btnXoa").on("click", VeXeBus.delete);
            },
            delete: function () {
                //Update
                $("#edit_header_ThongBao1").show();
                try {
                    $.getJSON(this.url + "HuyDichVu.aspx?ID=" + VeXeBus.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            complete: function () {
                ...
                try {
                    $.getJSON(this.url + "HoanThanhDichVu.aspx?ID=" + VeXeBus.ID + "&&Type=1", function (data) {
                        if (data == 1) {
            ...
            ThemMoi: function () {
                window.location.href = "/dichvu/VeXeBus_yeucaumoi";
            }
        };
    </script>
</asp:Content>

<%@ Page Title="Dịch vụ sinh viên" Language="C#" MasterPageFile="~/Site.Master" Async="true" AutoEventWireup="true" CodeBehind="HoTroHocTap_YeuCauMoi.aspx.cs" Inherits="Nuce.CTSV.HoTroHocTap_YeuCauMoi" %>
...
<asp:Content ID="BreadCrumContent" ContentPlaceHolderID="BreadCrum" runat="server">
    ...
    <div class="d-flex align-items-center">
        <a href="/dichvu/hotrohoctap.aspx">hỗ trợ học tập</a>
        <div id="circle" style="display: inline-block" class="ml-3 mr-3"></div>
    </div>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        var xacnhan_yeucaumoi = {
            ...
            vedanhsach: function () {
                window.location.href = "/dichvu/hotrohoctap";
            },
        };

...
namespace Nuce.CTSV
{
   ...
   SET [Email] = N'{0}'
      ...
      , txtBaoTin_HoVaTen.Text.Trim(), txtBaoTin_DiaChiNguoiNhan.Text.Trim()
      , txtBaoTin_SoDienThoai.Text.Trim()
      , txtBaoTin_Email.Text.Trim()
      , chkLaNoiTru.Checked ? 1 : 0
      , txtDiaChiCuThe.Text.Trim(), m_SinhVien.SinhVienID);

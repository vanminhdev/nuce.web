...
namespace nuce.ctsv
{
    public partial class HoanThanhDichVu : Page
    {
            ...
            try
            {
                ...
                else
                {
                        ...
                        ((Request.Form["ID"] != null) && (Request.Form["Type"] != null)))
                    {
                        ...
                        {
                            sql = string.Format(@"update [dbo].[{0}] set Status=6,LastModifiedBy=@Param0,LastModifiedTime=getdate() where ID=@Param1 and Status=4;
                                                  select 1;

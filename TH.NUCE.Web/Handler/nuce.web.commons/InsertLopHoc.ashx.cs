...
namespace nuce.web.commons
{
    ...
    public class InsertLopHoc : CoreHandlerCommonAdmin
    {
        public override void WriteData(HttpContext context)
        {
            ...
            if ((context.Request["userid"] != null) && (context.Request["monhocid"] != null) 
                 ...
                 (context.Request["mota"] != null))
            {
                ...
                data.dnn_NuceCommon_LopHoc.insert(monhocid, userid, blockid, ma, ten, sotinchi, mota, dtNgayBatDau,
                    dtNgayKetThuc);

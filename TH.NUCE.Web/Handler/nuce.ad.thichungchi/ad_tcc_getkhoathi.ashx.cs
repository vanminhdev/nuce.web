...
namespace nuce.web.commons
{
    ...
    public class ad_tcc_getkhoathi : CoreHandlerCommonAdminThiChungChi
    {
        public override void WriteData(HttpContext context)
        {
           // DataSet ds = data.dnn_NuceCommon_Khoa.getName(-1).DataSet;
            context.Response.ContentType = "text/plain";
            string sql = @"select a.*,b.Ten as TenMonThi from [dbo].[Nuce_ThiChungChi_KhoaThi] a inner join Nuce_ThiChungChi_MonThi b on a.MonThiID=b.ID where a.Status<>4";

...
namespace nuce.web.commons
{
    ...
    public class ad_tcc_deletenguoithi : CoreHandlerCommonAdminThiChungChi
    {
        public override void WriteData(HttpContext context)
        {
            string strID = context.Request["ID"].ToString();
            context.Response.ContentType = "text/plain";
            string sql = string.Format(@"UPDATE [dbo].[NUCE_ThiChungChi_NguoiThi] SET [Status]=4 WHERE ID={0}", strID);

...
namespace nuce.web.commons
{
    ...
    public class ad_tcc_deletekhoathi : CoreHandlerCommonAdminThiChungChi
    {
        public override void WriteData(HttpContext context)
        {
            ...
            string sql = string.Format(@"UPDATE [dbo].[Nuce_ThiChungChi_KhoaThi] SET [Status]={1} WHERE ID={0}", strID,strStatus);

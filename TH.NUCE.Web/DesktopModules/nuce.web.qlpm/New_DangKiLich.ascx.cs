...
{
    public partial class New_DangKiLich : PortalModuleBase
    {
        //New 
        //Edit
        //Delete
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (Type.Equals("new"))
            {
                if (data.dnn_NuceQLPM_LichPhongMay.Insert_DangKi(this.UserId, strMaDK, strMaCB, strHoVaTenCB, strLop, strMonHoc, strThu, strTietBatDau, strSoTiet
                     , "", PhongHocID, iBuoiHoc, "", Ngay, CaHocID, -1, -1, iSoSinhVien, "", strMoTa, "", Utils.synTypeLichHocTuDangKi, 3, chkCapNhatTheoMa.Checked).Equals(1))
                {
                    // ghi vao log
                    returnDS();
                }

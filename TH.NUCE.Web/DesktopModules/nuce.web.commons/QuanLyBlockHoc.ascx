<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyBlockHoc.ascx.cs" Inherits="nuce.web.commons.QuanLyBlockHoc" %>
...
<div style="text-align: center;" id="divFilter" runat="server">
    ...
    <span>
        <asp:DropDownList ID="ddlNamHoc" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlNamHoc_SelectedIndexChanged">
...
<div runat="server" id="divEdit">
    <table width="100%" cellpadding="10" cellspacing="10">
        <tr>
            ...
            <td>
                <div runat="server" id="divNameNamHoc" style="font-weight: bold; color: red;"></div>
            </td>
        </tr>
        <tr>
            <td>
...
<div style="display: none;">
    ...
    <asp:TextBox ID="txtNamHocID" runat="server"></asp:TextBox>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyBoCauHoi.ascx.cs" Inherits="nuce.web.thichungchi.QuanLyBoCauHoi" %>
...
<div runat="server" class="table-responsive" id="divContent"></div>

...
{
    public partial class SuaMatKhauCuaSinhVienTrongKiThi : CoreModule
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txtGhiChu.Text = data.dnn_NuceThi_KiThi_LopHoc_SinhVien.getMatKhau(m_iKiThi_Lophoc_SinhVienID);
            }
        }
        ...
        protected void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            data.dnn_NuceThi_KiThi_LopHoc_SinhVien.updateMatKhau(iID, strMoTa);
            returnMain();
        }

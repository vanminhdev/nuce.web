...
{
    public static class dnn_Nuce_KS_SinhVienRaTruong_BaiKhaoSat_SinhVien1
    {
        ...
        public static DataTable getBySv(int SvID)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"dnn_Nuce_KS_SinhVienRaTruong_BaiKhaoSat_SinhVien_GetBySV");
        ...
        public static void update_bailam1(int iID, string BaiLam,  DateTime NgayGioNopBai, string LogIP, int Status)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"dnn_Nuce_KS_SinhVienRaTruong_BaiKhaoSat_SinhVien_update_bailam1");
        ...
        public static void update_Type(int iID, int Type)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"dnn_Nuce_KS_SinhVienRaTruong_BaiKhaoSat_SinhVien_update_type");
        ...
        public static void SinhVien_THANGHN_insert(int Value, string Desc)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"dnn_Nuce_KS_SinhVienRaTruong_SinhVien_THANGHN_insert");
        ...
        public static void SinhVien_THANGHN_insert1(int Value, string Desc)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"dnn_Nuce_KS_SinhVienRaTruong_SinhVien_THANGHN_insert1");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, strSql, Value, Desc);

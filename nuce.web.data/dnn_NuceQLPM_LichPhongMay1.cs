...
{
    public static class dnn_NuceQLPM_LichPhongMay1
    {
            ...
            string MoTa, string GhiChu, int Type, int Status)
        {
            using (SqlConnection objConnection = Nuce_Common.GetConnection())
            {
                ...
                try
                {
                    ...
                    string strSql = string.Format(@"dnn_NuceQLPM_LichPhongMay_insert");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, strSql, MADK, MACB, HoVaTen, Lop, MonHoc, Thu, TietBD, SoTiet, MaPH, PhongHocID, BuoiHoc, TuanHoc

...
{
    public static class Nuce_DanhGiaGiangVien
    {
        #region Conection
        private static string m_strConnectionString = System.Configuration.ConfigurationSettings.AppSettings["NUCEDANHGIAGIANGVIEN"];
        ...
        private static string m_strPoolingConnectionString = System.Configuration.ConfigurationSettings.AppSettings["NUCEDANHGIAGIANGVIEN"];
...
SELECT ID
  ...
  where Status=3))", sinhvienID);
        ...
        public static void InsertAcademy_ClassRoom(int SemesterID, string Code, string GroupCode, string ClassCode,
           string SubjectCode, string ExamAttemptDate)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spAcademy_ClassRoom_Insert");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, SemesterID, Code, GroupCode, ClassCode,
                        SubjectCode, ExamAttemptDate);
                }
                catch
        ...
        public static void InsertAcademy_Student_ClassRoom(int SemesterID, string MaSV, string MaDK)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spAcademy_Student_ClassRoom_Insert");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, SemesterID, MaSV, MaDK);
                }
                catch
                {
...
inner join [dbo].[AS_Academy_C_Lecturer_ClassRoom] b on a.ClassRoomID=b.ClassRoomID 
 ...
 inner join [dbo].[AS_Academy_Lecturer] e on b.LecturerID=e.ID order by Name;", StudentID);
        ...
        public static DataSet getQA_QuestionNotReadByStudent(int StudentID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
  ...
  FROM [dbo].[AS_Edu_QA_Question] a left join [dbo].[AS_Academy_Lecturer] b on a.LecturerID=b.ID
  inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
  where StudentID={0} and a.Status<10 and IsStudent=1 and a.Status>1;
  select ID,Name,Template from [dbo].[AS_Edu_QA_Type] where Status=1;
select a.ClassRoomID,b.ID as LecturerClassRoomID,b.Template, b.LecturerID,b.LecturerCode,c.GroupCode,d.Name,e.FullName from (select StudentID,StudentCode,ClassRoomID from [dbo].[AS_Academy_C_Student_ClassRoom] where StudentID={0}) a
inner join [dbo].[AS_Academy_C_Lecturer_ClassRoom] b on a.ClassRoomID=b.ClassRoomID 
 inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
 inner join [dbo].[AS_Academy_Lecturer] e on b.LecturerID=e.ID  where a.ClassRoomID in (select ClassRoomID from [dbo].[AS_Edu_QA_Question] where Status>1 and IsStudent=1) order by Name;", StudentID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql);
                }
                catch
                {
...
(select * from [dbo].[AS_Academy_C_Lecturer_ClassRoom] where LecturerID={0}) a
 ...
 inner join [dbo].[AS_Academy_Lecturer] e on a.LecturerID=e.ID order by Name;", LeID);
        ...
        public static DataSet getQA_QuestionNotReadByLecturer(int LeID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
  ...
  inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
  inner join [dbo].[AS_Edu_QA_Type] e on a.Type=e.ID
  where LecturerID={0} and a.Status>1 and a.Status<10 and IsLecturer=1; 
  select ID,Name,Template from [dbo].[AS_Edu_QA_Type] where Status=1;
  select a.ClassRoomID,a.ID as LecturerClassRoomID,a.Template, a.LecturerID,a.LecturerCode,c.GroupCode,d.Name,e.FullName from 
(select * from [dbo].[AS_Academy_C_Lecturer_ClassRoom] where LecturerID={0}) a
 inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
 inner join [dbo].[AS_Academy_Lecturer] e on a.LecturerID=e.ID where a.ClassRoomID in (select ClassRoomID from [dbo].[AS_Edu_QA_Question] where Status>1 and IsLecturer=1)
order by Name;", LeID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql);
                }
                catch
...
");
     ...
     VALUES
        ...
        #endregion
        #region QA_MESSAGE
        public static void InsertMessage(int LecturerID, string LecturerCode, int ClassRoomID, int Type, string Message,int Status)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spQA_insertMessage");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, LecturerID, LecturerCode, ClassRoomID, Type, Message, Status);
                }
                catch (Exception ex)
                {
                    return;
        ...
        public static void InsertMessage(int LecturerID, string LecturerCode, int ClassRoomID, int Type, string Message, int Status, string File)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spQA_insertMessage1");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, LecturerID, LecturerCode, ClassRoomID, Type, Message, Status, File);
                }
                catch (Exception ex)
                {
                    return;
        ...
        public static void UpdateMessage(int ID, int LucturerID, string LucturerCode, int ClassRoomID,  string Message)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spQA_updateMessage");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, ID, LucturerID, LucturerCode, ClassRoomID, Message);
                }
                catch (Exception ex)
                {
                    return;
        ...
        public static void UpdateMessage(int ID, int LucturerID, string LucturerCode, int ClassRoomID, string Message,string File)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"spQA_updateMessage1");
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteScalar(objConnection, strSql, ID, LucturerID, LucturerCode, ClassRoomID, Message, File);
                }
                catch (Exception ex)
                {
                    return;
        ...
        public static void UpdateMessage(int ID, int StudentID, int Status)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    ...
                    string strSql = "";
                    if (Status < 3)
                        strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},CreatedTime=getDate() WHERE ID={1} and StudentID={2}", Status, ID, StudentID);
                    else
                        strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},UpdatedTime=getDate() WHERE ID={1} and StudentID={2}", Status, ID, StudentID);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static void UpdateMessage(int ID, int Status)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    ...
                    string strSql = "";
                    if (Status < 3)
                        strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},CreatedTime=getDate() WHERE ID={1}", Status, ID);
                    else
                        strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},UpdatedTime=getDate() WHERE ID={1}", Status, ID);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static void UpdateMessage_IsLecturer(int ID, int IsLecturer)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = "";
                    strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET IsLecturer={0} WHERE ID={1}", IsLecturer, ID);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static void UpdateMessage_IsStudent(int ID, int IsStudent)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = "";
                    strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET IsStudent={0} WHERE ID={1}", IsStudent, ID);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static void UpdateMessage(int ID, int LecturerID, string strAnswer, int Status)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = "";
                    strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},UpdatedTime=getDate(),Answare=N'{1}' WHERE ID={2} and LecturerID={3}", Status, strAnswer, ID, LecturerID);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static void UpdateMessage1(int ID, int LecturerID, string strAnswer, int Status, string File)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = "";
                    strSql = string.Format(@"UPDATE [dbo].[AS_Edu_QA_Message] SET status={0},UpdatedTime=getDate(),Answare=N'{1}',Le_Attachment=N'{4}' WHERE ID={2} and LecturerID={3}", Status, strAnswer, ID, LecturerID, File);
                    Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteNonQuery(objConnection, CommandType.Text, strSql);
                }
                catch (Exception ex)
                {
        ...
        public static DataSet getQA_MessageByStudent(int StudentID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = string.Format(@"SELECT a.*,b.FullName,d.Name,c.GroupCode
  FROM [dbo].[AS_Edu_QA_Message] a left join [dbo].[AS_Academy_Lecturer] b on a.LecturerID=b.ID
  inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
  where StudentID={0} and a.Status<10;
  select ID,Name,Template from [dbo].[AS_Edu_QA_Type] where Status=1;
select a.ClassRoomID,b.ID as LecturerClassRoomID,b.Template, b.LecturerID,b.LecturerCode,c.GroupCode,d.Name,e.FullName from (select StudentID,StudentCode,ClassRoomID from [dbo].[AS_Academy_C_Student_ClassRoom] where StudentID={0}) a
inner join [dbo].[AS_Academy_C_Lecturer_ClassRoom] b on a.ClassRoomID=b.ClassRoomID 
 ...
 inner join [dbo].[AS_Academy_Lecturer] e on b.LecturerID=e.ID order by Name;", StudentID);
        ...
        public static DataTable getQA_MessageByStudent1(int StudentID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"select * from [dbo].[AS_Edu_QA_Message]
where Status>1 and (StudentID={0} or ClassRoomID in 
(select distinct([ClassRoomID]) from [dbo].[AS_Academy_C_Student_ClassRoom] where StudentID={0}))", StudentID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql).Tables[0];
                }
                catch
                {
        ...
        public static DataSet getQA_MessageNotReadByStudent(int StudentID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
...
inner join [dbo].[AS_Academy_C_Lecturer_ClassRoom] b on a.ClassRoomID=b.ClassRoomID 
 inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
 inner join [dbo].[AS_Academy_Lecturer] e on b.LecturerID=e.ID  where a.ClassRoomID in (select ClassRoomID from [dbo].[AS_Edu_QA_Message] where Status>1 and IsStudent=1) order by Name;", StudentID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql);
                }
                catch
                {
        ...
        public static DataTable getQA_MessageByLecturer1(int LeID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"SELECT a.*,b.[GroupCode]
  FROM [dbo].[AS_Edu_QA_Message] a left join [dbo].[AS_Academy_C_ClassRoom] b
  on a.[ClassRoomID]=b.ID where LecturerID={0} and a.Status<4;", LeID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql).Tables[0];
                }
                catch
                {
        ...
        public static DataSet getQA_MessageByLecturer(int LeID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = string.Format(@"SELECT a.*,b.FulName,d.Name,c.GroupCode,e.Name as NameType
  FROM [dbo].[AS_Edu_QA_Message] a left join [dbo].AS_Academy_Student b on a.StudentID=b.ID
  inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
  inner join [dbo].[AS_Edu_QA_Type] e on a.Type=e.ID
  where LecturerID={0} and a.Status>1 and a.Status<10; 
  select ID,Name,Template from [dbo].[AS_Edu_QA_Type] where Status=1;
...
(select * from [dbo].[AS_Academy_C_Lecturer_ClassRoom] where LecturerID={0}) a
 ...
 inner join [dbo].[AS_Academy_Lecturer] e on a.LecturerID=e.ID order by Name;", LeID);
        ...
        public static DataSet getQA_MessageNotReadByLecturer(int LeID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
...
(select * from [dbo].[AS_Academy_C_Lecturer_ClassRoom] where LecturerID={0}) a
 inner join [dbo].[AS_Academy_C_ClassRoom] c on a.ClassRoomID=c.ID inner join [dbo].[AS_Academy_Subject] d on c.SubjectID=d.ID
 inner join [dbo].[AS_Academy_Lecturer] e on a.LecturerID=e.ID where a.ClassRoomID in (select ClassRoomID from [dbo].[AS_Edu_QA_Message] where Status>1 and IsLecturer=1)
order by Name;", LeID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql);
                }
                catch
        ...
        public static DataTable getQA_MessageByID(int ID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
                ...
                try
                {
                    //Execute select command
                    string strSql = string.Format(@"SELECT a.*
  FROM [dbo].[AS_Edu_QA_Message] a where a.ID={0} or -1={0}", ID);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql).Tables[0];
                }
                catch
                {
        ...
        public static DataTable getQA_MessageDetailByID(int ID)
        {
            using (SqlConnection objConnection = GetConnection())
            {
                if (objConnection == null)
    ...
    , int Order, int Level, string Type, int Status)
        ...
        public static DataTable Authenticate(string username, string password)
        {
            ...
            using (SqlConnection objConnection = GetConnection())
            {
                ...
                {
                    //Execute select command
                    string strSql = string.Format(@"SELECT * from GS_User where Username='{0}' and Password='{1}'", username, password);
                    return Microsoft.ApplicationBlocks.Data.SqlHelper.ExecuteDataset(objConnection, CommandType.Text, strSql).Tables[0];
                }
                catch
                {

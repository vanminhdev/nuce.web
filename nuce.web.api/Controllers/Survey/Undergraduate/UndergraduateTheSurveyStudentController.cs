...
namespace nuce.web.api.Controllers.Survey.Undergraduate
{
    ...
    public class UndergraduateTheSurveyStudentController : ControllerBase
    {
        ...
        private readonly AsEduSurveyUndergraduateBaiKhaoSatSinhVienService _asEduSurveyUndergraduateBaiKhaoSatSinhVienService;
        ...
        public UndergraduateTheSurveyStudentController(ILogger<UndergraduateTheSurveyStudentController> logger, 
            ...
            AsEduSurveyUndergraduateBaiKhaoSatSinhVienService asEduSurveyUndergraduateBaiKhaoSatSinhVienService)
        {
            _logger = logger;
        ...
        [HttpPut]
        [AppAuthorize(RoleNames.UndergraduateStudent)]
        public async Task<IActionResult> SaveSelectedAnswer([Required] Guid? theSurveyId, [FromBody] List<AnswerSaveVM> data)
        {
            try
            {
                var studentCode = _userService.GetCurrentStudentCode();
                var ip = HttpContext.Connection.RemoteIpAddress.ToString();
                await _asEduSurveyUndergraduateBaiKhaoSatSinhVienService.SaveSelectedAnswer(theSurveyId.Value, studentCode, ip, data);
            }

...
namespace nuce.web.api.Controllers.Survey.Graduate
{
    ...
    public class GraduateSurveyRoundController : ControllerBase
    {
        ...
        public GraduateSurveyRoundController(ILogger<GraduateSurveyRoundController> logger, AsEduSurveyGraduateDotKhaoSatService asEduSurveyGraduateDotKhaoSatService)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> GetSurveyRoundClosedOrEnd()
        {
            try
            {
                var result = await _asEduSurveyGraduateDotKhaoSatService.GetSurveyRoundClosedOrEnd();
                return Ok(result);
            }
            catch (Exception e)
            {
